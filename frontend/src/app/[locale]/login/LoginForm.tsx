  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ margin: "0 0 0.25rem", fontSize: "1.35rem", textAlign: "center" }}>{tLogin("title")}</h1>
        <p style={{ margin: "0 0 1.25rem", color: "var(--muted)", fontSize: "0.9rem", textAlign: "center" }}>
          {tLogin("subtitle")}
        </p>
