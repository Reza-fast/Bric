    ...
    <DashboardShell user={user} fullBleed>
      <div style={{ display: "flex", minHeight: "100%", width: "100%" }}>
        ...
        >
          ...
          <nav style={{ flex: 1, overflow: "auto", padding: "0.65rem 0.5rem" }}>
            <button
              type="button"
        ...
        {/* Main content */}
        <div style={{ flex: 1, minWidth: 0, padding: `1.35rem ${pagePad} 2rem` }}>
          <div style={{ marginBottom: "1.25rem" }}>
            <div style={{ fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.12em", color: "#64748b" }}>
              DOCUMENTS
            </div>
            <h1 style={{ margin: "0.35rem 0 0", fontSize: "1.75rem", fontWeight: 800, letterSpacing: "-0.02em" }}>
              Technical plans
            </h1>
            <p style={{ margin: "0.45rem 0 0", color: "#64748b", fontSize: "0.9rem", maxWidth: 640, lineHeight: 1.5 }}>
              Drawings, specifications, and CAD files for your projects. Filter by project in the sidebar, upload new plans,
              and open or download any file.
            </p>
